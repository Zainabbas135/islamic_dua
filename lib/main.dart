...
class Splash2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SplashScreen(
      ...
      title: new Text('اَللّهُمَّ عَجِّل لِوَلیِّکَ الفَرَج',
          textScaleFactor: 2, style: TextStyle(fontSize: 14)),
      image:
          Image.asset('assets/images/finalimg1.jpg', width: 1000, height: 1000),
        ...
        onTap: () {
          if (choice.title == 'صفحہ نمبر 1')
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => __On1stPage()));
      ...
      home: Scaffold(
        ...
        body: Column(children: <Widget>[
          ...
          Container(
            ...
            child: FlatButton(
              child: new Text(
                'سلام  آدم  پر  جو  برگزیدہ  خدا  اور  خلیفہ  خدا  ہیں۔'
